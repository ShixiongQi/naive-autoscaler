...
class TestAutoscaler(object):
    ...
    def setup(self):
        ...
        self.autoscaler = Autoscaler(self.config, self.scaling_client, self.metric_store_factory, self.scheduler, self.mock_datetime)
    ...
    def test_run_gets_replica_count_of_the_service_from_scaling_client(self):
        ...
        self.scaling_client.get_bouncer_replica_count.assert_called_once_with(network_name="network_1", service_name="bouncer")
    ...
    def test_run_gets_metric_value_from_metric_strore_for_configured_metric_query(self):
        ...
        self.monitoring_metric_store.get_metric_value.assert_called_once_with(300)
    ...
    def test_run_scales_up_service_replicas_when_metric_value_is_above_scale_up_threshold(self):
        ...
        self.scaling_client.scale_service.assert_called_once_with(network_name="network_1", service_name = "bouncer", replica_count = 2)
    ...
    def test_run_scales_up_service_replicas_when_metric_value_is_above_scale_up_threshold_and_current_replica_count_is_close_to_scale_max(self):
        ...
        self.scaling_client.scale_service.assert_called_once_with(network_name="network_1", service_name = "bouncer", replica_count = 3)
    ...
    def test_run_scales_down_service_replicas_when_metric_value_is_below_scale_down_threshold_and_current_replica_count_close_to_scale_down_threshold(self):
        ...
        self.scaling_client.scale_service.assert_called_once_with(network_name="network_1", service_name = "bouncer", replica_count = 1)
